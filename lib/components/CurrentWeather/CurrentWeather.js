    ...
    <div className='Condition-background'>
      <div className='Current-condition-container'>
        ...
        <div className='Current-location-container'>
          ...
          <p className='Current-date-text'>{props.monthName} {props.day}, {props.year}</p>
          <p className='Current-high-text'>High: {props.highTemp}&#176;</p>
          <p className='Current-low-text'>Low: {props.lowTemp}&#176;</p>
        </div>
    </div>
  );
}
